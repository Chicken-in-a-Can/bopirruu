...
featured1 = ttk.Label(homeTab, text = allPackages[0], font = ("Times",12))
featured2 = ttk.Label(homeTab, text = allPackages[1], font = ("Times",12))
featured3 = ttk.Label(homeTab, text = allPackages[3], font = ("Times",12))
