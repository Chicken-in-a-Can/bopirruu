...
def openPackagePage(featured = ""):
    ...
    packageScreen.geometry("600x600")
    ...
    def installCommand():
        ...
        root.after(7500, doneInstallingCommand)
...
fileUploadButton = ttk.Button(uploadTab, text = "Choose File:", command = uploadAction)
...
versionLabel = ttk.Label(uploadTab, text = "Version Number:", font = ("Times",12))
versionLabel.grid(column = 0, row = 3, padx = 10, pady = 10)
versionText = tk.Entry(uploadTab, font = ("Times",12), width = 50)
versionText.grid(column = 1, row = 3, padx = 10, pady = 10)

descriptionLabel = ttk.Label(uploadTab, text = "Description:", font = ("Times",12))
descriptionLabel.grid(column = 0, row = 4, padx = 10, pady = 10)
descriptionText = tk.Text(uploadTab, font = ("Times",12), height = 5, width = 50)
descriptionText.grid(column = 1, row = 4, padx = 10, pady = 10)


def uploadCommand():
    print(fileNameLabel['text'])
    print(nameText.get())
    print(versionText.get())
    print(descriptionText.get("1.0","end-1c"))
uploadButton = ttk.Button(uploadTab, command = uploadCommand, text = "Upload Package")
uploadButton.grid(column = 0, row = 5, padx = 10, pady = 10)
